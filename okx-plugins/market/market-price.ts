...
export class okxmarketprice extends PluginBase<WalletClientBase> {
    ...
    getTools(walletClient: WalletClientBase) {
        return [
            createTool(
                {
                    name: "okx_market_price",
                    description: "Get the latest price of SOL token",
                    parameters: z.object({}),
                },
...
export const Marketprice = () => new okxmarketprice()